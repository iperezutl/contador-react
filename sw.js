...
//Trabajando con el primer evento del service worker llamado install , el cual es la primer parte del ciclo de vida de un service worker, que es cuando se registra se instala y lo que va a hacer al instalarse es chacear todas las rutas para que ahora el service worker me provea de toda esa infomración y ya no tenga que estar haciendo peticiones a internet a cada rato 
...
//Trabajando con el siguiente evento del service worker llamado fetch, es el evento que se va a disparar cada que nosotros abramos el sitio, por ejemplo, lo que va a hacer buscará una nueva versión de nuestros archivos en cache, y va a retornar las respuestas que tengan el caché activado. En caso de que se vaya a crear una nueva habra que hacer la petición y respondernos una nueva cosa.
